		...
		<div class="spill">
				...
				<table>
					<tbody>
						<tr>
							...
							<td><span
								<c:if test="${spillerSinTur == 0}"> class="tur"</c:if>>
									${spillerListe[0]}</span></td>
							<td><span
								<c:if test="${spillerSinTur == 1}"> class="tur"</c:if>>
									${spillerListe[1]}</span></td>
							<td><span
								<c:if test="${spillerSinTur == 2}"> class="tur"</c:if>>
									${spillerListe[2]}</span></td>
							<td><span
								<c:if test="${spillerSinTur == 3}"> class="tur"</c:if>>
									${spillerListe[3]}</span></td>
							<td><span
								<c:if test="${spillerSinTur == 4}"> class="tur"</c:if>>
									${spillerListe[4]}</span></td>
							<td><span
								<c:if test="${spillerSinTur == 5}"> class="tur"</c:if>>
									${spillerListe[5]}</span></td>
						</tr>
						<tr>
							<td>Enere</td>
			...
			<div class="dicearea">
				<form method="post">
					<table>
						<tr>
							<td><img id='d0' src="images/dice${dice1}.gif"
								alt="${dice1}" onclick="holddice()"></td>
							<td><img id='d1' src="images/dice${dice2}.gif"
								alt="${dice2}" onclick="holddice()"></td>
							<td><img id='d2' src="images/dice${dice3}.gif"
								alt="${dice3}" onclick="holddice()"></td>
							<td><img id='d3' src="images/dice${dice4}.gif"
								alt="${dice4}" onclick="holddice()"></td>
							<td><img id='d4' src="images/dice${dice5}.gif"
								alt="${dice5}" onclick="holddice()"></td>
